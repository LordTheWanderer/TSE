...
// cloudflare: open in tab instead of fetch(), to bypass cloudflare protection
// windows1251Search: convert url search text 1251 to abrakadabra

const trackersDefault = [
  {
    trackerName: "Rutracker", // mirrors: https://rutracker.net
    trackerActive: true,
  ...
  },
  {
    ...
    searchURLTopSeeds: "https://rutor.info/search/0/0/100/2/",
    method: "GET",
    windows1251: false,
    windows1251Search: false,
    authReq: false,
  ...
  {
    trackerName: "Kinozal", // mirrors: https://kinozal.tv https://kinozal.guru
    trackerActive: false,
    ...
    trackerURL: "https://kinozal.me",
    searchURL: "https://kinozal.me/browse.php?s=",
    searchURLTopSeeds: "https://kinozal.me/browse.php?t=1&s=",
    method: "GET",
    windows1251: true,
    windows1251Search: false,
    authReq: false,
    ...
    url: "td.nam>a",
    baseDownloadURL: "https://kinozal.me",
    downloadURL: "td.nam>a",
    cloudflare: true,
  },
  // {
  //   trackerName: "Piratbit", // disabled
  //   trackerActive: false,
