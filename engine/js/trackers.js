...
const trackersDefault = [
  ...
  },
  {
    ...
    searchURL: "http://kinozal.tv/browse.php?s=",
    searchURLTopSeeds: "http://kinozal.tv/browse.php?t=1&s=",
    method: "GET",
    windows1251: true,
    authReq: false,
    authURL: "",
    ...
    url: "td.nam>a",
    baseDownloadURL: "http://kinozal.tv",
  ...
  },
  {
    ...
    selector: "#tor-tbl>tbody>tr",
    skipFromStart: 0,
    title: "td.row4.med.tLeft>a.genmed:last-child",
    date: "td.row4.small.nowrap:last-child>u",
    dateType: ["byte", ""],
    size: "td.row4.small.nowrap>u",
    sizeType: ["byte", ""],
  ...
  },
  {
    ...
    baseDownloadURL: "http://www.filebase.ws",
    downloadURL: "td:nth-child(2)>a"
  },
  {
